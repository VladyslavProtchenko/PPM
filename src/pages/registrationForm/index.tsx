...
const Registration = () => {
  ...
  const {
    ...
    watch,
    reset,
  } = useForm<IUserRegistration>({ mode: "all" });
        ...
        <div className={formContainer}>
          ...
          <form className={loginForm} onSubmit={handleSubmit(onSubmit)}>
            <div className={controlBlock}>
              ...
              <input
                className={
                  controlInput + `${errors.firstName ? " border-red-500" : ""}`
                }
                type="text"
            ...
            <div className={controlBlock}>
              ...
              <input
                className={
                  controlInput + `${errors.lastName ? " border-red-500" : ""}`
                }
                type="text"
                placeholder="Username or Email"
                {...register("lastName", {
            ...
            <div className={controlBlock}>
              ...
              <input
                className={
                  controlInput + `${errors.email ? " border-red-500" : ""}`
                }
                type="email"
                placeholder="Username or Email"
                {...register("email", {
            ...
            <div className={controlBlock}>
              ...
              <div className={passwordWrapper}>
                <input
                  className={
                    controlInput + `${errors.password ? " border-red-500" : ""}`
                  }
                  ...
                  {...register("password", {
                    ...
                    maxLength: {
                      value: 20,
                      message: "Password must be not longer than 20 characters",
                    },
                    validate: {
                      pattern1: (value) =>
            ...
            <Link to={"/profile"} className={registrationBtn} type="submit">
              Registration
            </Link>
          </form>
        </div>
...
const wrapper =
  "flex justify-center items-center h-screen antialiased bg-[#f4f1ed] text-gray-900 font-sans h-[100%]";
const formContainer = "flex flex-col w-[70%] bg-white rounded p-8 m-4";
const loginHead =
  "text-center block w-full text-p uppercase font-bold mb-4 text-[#c5b7af]";
...
const controlInput =
  "w-full border rounded p-2 outline-none focus:shadow-outline";
const passwordWrapper = "relative";
const passwordIcon = "absolute top-[25%] right-[3%] text-[22px]";
const registrationBtn =
  "bg-[#9e928c] hover:bg-[#8a807a] text-white uppercase text-sm font-semibold px-4 py-2 rounded";
