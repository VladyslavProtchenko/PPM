...
const infoItem =
  "flex text-gray-800 text-[16px] font-normal  text-[#623e2a] font-lato mr-[10px]";
// const dataItem = 'text-gray-600 pl-3 text-sm font-thin font-lato'

const returnBtn =
  "max-w-[300px] self-center rounded-lg px-4 py-2 bg-[#9e928c] text-gray-100 hover:bg-[#8a807a] duration-300 font-gilda text-p lg:text-pLg md:text-pMg sm:text-pSm";

const editIcon = "absolute text-xl top-[88px] right-8";
const greeting =
  "flex text-[#623e2a] text-4xl font-light  font-gilda mb-6 pl-20";
...
const section =
  "bg-[#ffff] h-full w-screen flex justify-center font-lato items-center";
