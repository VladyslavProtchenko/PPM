...
export const useMainPage = create<State>()((set) => ({
    content: [
        ...
        },
        {
            ...
            text2: 'Sell smarter by really understanding your customers, identifying what makes your product or service unique, setting achievable goals, and creating a game plan to reach the right people in the right way.',
        },
        {
            section: 4,
            ...
            text2: 'Our HR solutions can include recruiting, screening, and hiring candidates, as well as providing onboarding, training, recruitment, and workforce planning.',
        },
        {
            section: 5,
        ...
        },
        {
            ...
            text2:'Tatiana and her team of industry-specific experts can help propel your brand to new heights. Their approach is collaborative, transparent, and results-driven, providing the highest level of service to clients.',
        },
    ],
