...
const UserAccounts: FC<Props> = ({ columns, rows }) => {
    ...
    renderCell: (params) => {
      return (
        <div className="flex items-center justify-between ">
          ...
          <Button onClick={() => handleAccount(params.row, "delete")}>
            <DeleteIcon />
          </Button>
        </div>
      );
  ...
  return (
    <div className="dataTable">
      <Box className="mb-[40px] xxl:max-w-[1200px] xl:max-w-[1000px] lg:max-w-[700px] md:max-w-[600px] sm:max-w-[500px]">
        <DataGrid
          className="overflow-auto bg-[white] p-[20px]"
          rows={rows}
